...
int main() {
  ...
  if (distance != 1.0) {
    ...
    cout << "KDT Test1: Distance 1 is correct" << endl;
  }
  ...
  if (distance != 4.0) {
    ...
    cout << "KDT Test1: Distance 2 is correct" << endl;
  }
  ...
  if (distance != 2.0) {
    ...
    cout << "KDT Test1: Distance 3 is correct" << endl;
  }
 ...
 //(1.0, 3.2), (3.2, 1.0), (5.7, 3.2), (1.8, 1.9), (4.4, 2.2)
 //(1.0, 3.2), (1.8, 1.9), || (3.2, 1.0), || (4.4, 2.2), (5.7, 3.2)
 //(1.8, 1.9), || (1.0, 3.2), (3.2, 1.0), (4.4, 2.2) || (5.7, 3.2)
  ...
  cout << "About to start tests for find" << endl; 
  /* Test find */
